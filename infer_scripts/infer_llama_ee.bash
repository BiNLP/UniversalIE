CUDA_VISIBLE_DEVICES=0,1 python src/inference.py \
    ...
    --template 'llama2' \
    --do_predict \
    --input_file '/scratch2/nlp/chenzhenbin/Workspaces/IEPile/data/zjunlp/iepile/IE-en/EE/ADE_corpus/test.json' \
    --output_file 'results/llama2-13b-ace05-continue_ee.json' \
