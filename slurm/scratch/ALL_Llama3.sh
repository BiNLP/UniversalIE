output_dir='/home/chenzhb/Workspaces/UniversalIE/lora/llama3-8b-iepile-ALL'
mkdir -p ${output_dir}
CUDA_VISIBLE_DEVICES="0,1" torchrun --nproc_per_node=2 --master_port=1288  ../../src/finetune.py \
    --do_train \
	--do_eval \
    --overwrite_output_dir \
    --model_name_or_path '/home/chenzhb/Workspaces/LLMs/Meta-Llama-3-8B-Instruct/' \
    --checkpoint_dir '/home/chenzhb/Workspaces/LLMs/llama3-8b-iepile-lora' \
    --stage 'sft' \
    --model_name 'llama' \
    --template 'alpaca' \
