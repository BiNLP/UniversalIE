...
statistic_file="/home/chenzhb/Workspaces/UniversalIE/statistic/ReDocRED/RE_split4/"
...
CUDA_VISIBLE_DEVICES=0,1 python ../../src/inference.py \
    ...
    --template 'alpaca' \
    --do_predict \
    --input_file '/home/chenzhb/Workspaces/Datasets/UIE/Re-DocRED/IEPile_format/RE/test_iepile.json' \
    --output_file '/home/chenzhb/Workspaces/UniversalIE/results/RE/ReDocRED/llama3-8b-drop-50.json' \
