...
statistic_file="/home/chenzhb/Workspaces/UniversalIE/statistic/ReDocRED/"
...
CUDA_VISIBLE_DEVICES=0,1 python ../../src/inference.py \
    ...
    --template 'alpaca' \
    --do_predict \
    --input_file '/home/chenzhb/Workspaces/Datasets/UIE/ToyData/ReDocRED_test.json' \
    --output_file '/home/chenzhb/Workspaces/UniversalIE/results/RE/ReDocRED/test.json' \
