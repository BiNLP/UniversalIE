...
statistic_file="/home/chenzhb/Workspaces/UniversalIE/statistic/ReDocRED/NER_split6/"
...
CUDA_VISIBLE_DEVICES=0,1 python ../../src/inference.py \
    ...
    --output_file '/home/chenzhb/Workspaces/UniversalIE/results/NER/ReDocRED/llama3-8b-drop-50.json' \
