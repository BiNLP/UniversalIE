...
CUDA_VISIBLE_DEVICES=0,1 python ../../src/inference.py \
    ...
    --output_file '/home/chenzhb/Workspaces/UniversalIE/results/NER/DWIE/llama3-8b-all.json' \
...
python ../../ie2instruction/eval_func.py \
  --path1 /home/chenzhb/Workspaces/UniversalIE/results/NER/DWIE/llama3-8b-all.json \
  --task NER
