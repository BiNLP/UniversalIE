...
CUDA_VISIBLE_DEVICES="0,1" torchrun --nproc_per_node=2 --master_port=1287 src/finetune.py \
    ...
    --model_name 'llama' \
    --template 'llama2' \
    --train_file '/home/chenzhenbin/Workspaces/IEPile/data/ACE2005/IEPile_format/train.json' \
    --valid_file '/home/chenzhenbin/Workspaces/IEPile/data/ACE2005/IEPile_format/dev.json' \
